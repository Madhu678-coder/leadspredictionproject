...
with DAG(
    ...
    description='Lead scoring pipeline using SageMaker',
    schedule_interval=timedelta(days=1),
    start_date=days_ago(1),
    catchup=False,
) as dag:

    s3_bucket = 'airflowcapstone'
    mlflow_tracking_uri = 'arn:aws:sagemaker:ap-south-1:888517279277:mlflow-tracking-server/capstone'
    model_name = 'LeadScoring_Simplified'
    sagemaker_role = 'arn:aws:iam::888517279277:role/service-role/AmazonSageMaker-ExecutionRole-20250718T103832'
